...
const portfolioItems = [
  {
    ...
    description: "Разработка современного интернет-магазина с интеграцией платежных систем",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1520333789090-1afc82db536a?w=500&h=350&fit=crop",
    category: "Приложения"
  },
  {
    title: "Корпоративный сайт строительной компании",
    description: "Создание презентационного сайта с каталогом услуг и портфолио проектов",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1596524430615-b46475ddff6e?w=500&h=350&fit=crop",
    category: "Боты"
  },
  {
    title: "Сайт образовательной платформы",
    description: "Онлайн-платформа для обучения с личным кабинетом и системой тестирования",
  ...
  },
  {
    ...
    description: "Приложение с тренировками, отслеживанием прогресса и планом питания",
    image: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=500&h=350&fit=crop",
    category: "Приложения"
  }
];
    ...
    <section id="portfolio" className="section-padding">
      <div className="container">
        ...
        <p className="section-subtitle">
          Познакомьтесь с моими лучшими работами и проектами, реализованными для клиентов
        </p>

        <Tabs defaultValue="Все проекты" className="w-full" onValueChange={setActiveTab}>
          ...
          {portfolioCategories.map((category) => (
            <TabsContent key={category} value={category} className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {portfolioItems
                  .filter(item => category === "Все проекты" || item.category === category)
                  .map((item, index) => (
                    <div key={index} className="portfolio-item rounded-lg overflow-hidden shadow-md">
                      <img 
                        src={item.image} 
                        alt={item.title} 
